...
public class Uniprogrammed {
    ...
    public static void Uniprogrammed(int numProcesses, Process[] array1, boolean verbose) {
        ...
        while (numTerminatedProcesses < numProcesses) {
             ...
             **/
            if ((!runningProcess) && process_number<numProcesses && array1[process_number].getStatus().equals("Ready")) {
                Process x = array1[process_number];
                x.setStatus("Running");
